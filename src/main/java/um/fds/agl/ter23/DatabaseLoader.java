...
public class DatabaseLoader implements CommandLineRunner {
    ...
    private final SujetRepository<Sujet> sujets;
    private final StudentRepository students;


    @Autowired
    public DatabaseLoader(TeacherRepository teachers, TERManagerRepository managers, StudentRepository students, SujetRepository<Sujet> sujets) {
    ...
    public void run(String... strings) throws Exception {
       ...
       SecurityContextHolder.getContext().setAuthentication(
        ...
        this.sujets.save(new Sujet("Hello",T1, "Turing"));
        this.sujets.save(new Sujet("Hello",T1, "Turing"));
